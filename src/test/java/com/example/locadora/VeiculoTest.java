...
public class VeiculoTest {
    ...
    class iserirDiasAlugados {
        ...
        void deveInserirDiasAlugaodQuandoValorMaiorZero() throws IllegalAccessException {
            int diaValido = 2;
        ...
        void deveLancarExceptionQuandoDiasAlugadosNaoValido() throws IllegalAccessException {
            int diaInvalido = 0;

            Veiculo veiculo = new Veiculo();
            Executable executable = () -> veiculo.setDiasAlugados(diaInvalido);

            IllegalAccessException illegalAccessException = assertThrows(IllegalAccessException.class, executable);
        }
    }
    ...
    class multa {
        ...
        void deveAplicarMultaQuandoDiasAlugadosMenorDiasDeUso() throws IllegalAccessException {
            int diasAlugados = 7;
    ...
    class descontos {
        ...
        void deveAplicarDescontoNormalParaDiasDeUsoIgualSete() throws IllegalAccessException {
            int diasAlugados = 7;
            int diasDeUso = 7;
        ...
        void deveAplicarDescontoMaiorParaDiasDeUsoMaiorSete() throws IllegalAccessException {
            int diasAlugados = 8;
            int diasDeUso = 8;
    ...
    class casoNormal {
        ...
        void deveRetornarValorSemDescontosOuMulta() throws IllegalAccessException {
            int diasAlugados = 6;
            int diasDeUso = 6;
